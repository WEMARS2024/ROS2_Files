...
from interfaces import Controls  # Import custom Controls message
from interfaces import ControlsArray  # Import custom ControlsArray message
...
class PS4ControllerPublisher(Node):
    ...
    def publish_controller_data(self):
        ...
        # Create a ControlsArray message and populate its 'inputs' array with controls_msg
        msg = ControlsArray()
        msg.inputs = [controls_msg]  # Place the Controls message in the array
